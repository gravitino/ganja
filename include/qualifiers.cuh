...
#define GANJA_QUALIFIERS_CUH
    ...
    #define HOSTDEVICEINLINEQUALIFIER HOSTDEVICEQUALIFIER INLINEQUALIFIER
    #define HOSTINLINEQUALIFIER       HOSTQUALIFIER       INLINEQUALIFIER
    #define DEVICEINLINEQUALIFIER     DEVICEQUALIFIER     INLINEQUALIFIER
